class User < ActiveRecord::Base
  ...
  attr_accessible :email, :password,:username,:lastname,:companyname,:telephone,:fax,:country,:zipcode,:city,:stateprovince,:address, :password_confirmation, :common, :remember_me
